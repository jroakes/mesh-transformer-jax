...
python3 device_sample_df.py --config=configs/company_data.json --sample_file zoominfo_test.csv --prompt_column model_input --name_column name --num_samples 100 --temp 0.75 --top_p 0.90 --rep_penalty 1.3 ----rep_window 200
